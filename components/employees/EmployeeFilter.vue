<template>
  <div class="bg-white dark:bg-slate-900 p-4 rounded-3xl border border-gray-200 dark:border-slate-800 shadow-sm flex flex-col gap-3 md:flex-row md:items-end">
    ...
    <div class="flex items-end">
      <button
        @click="resetFilters"
        class="w-full rounded-2xl bg-slate-100 px-4 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700"
      >
        Xóa bộ lọc
      </button>
    </div>
